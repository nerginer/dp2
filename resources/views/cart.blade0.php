...
@section('content')
    ...
    <div class="container">
        <p><a href="{{ url('dps') }}">Home</a> / Cart</p>
        <h1>Your Cart</h1>
        ...
        @if (sizeof(Cart::content()) > 0)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="table-image"><a href="{{ url('dps', [$item->dps->id]) }}"><img src="{{ asset('thumbnail/' . $item->dps->image) }}" alt="product" class="img-responsive cart-image"></a></td>
                        <td><a href="{{ url('dps', [$item->dps->id]) }}">{{ $item->dps->name }}</a></td>
                        <td>
